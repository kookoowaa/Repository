...
{
  dat_tmp[i,5]<- gsub(pattern = '[ㅋㅎㅠㅜ]', replace='', gsub(pattern = "<[/|A-Za-z]*>",  replace = "", gsub(pattern = "&[a-z]*;",  replace = "", final_dat[i,5])))
    dat_tmp[i,1]<- gsub(pattern = '[ㅋㅎㅠㅜ]', replace='',  gsub(pattern = "<[/|A-Za-z]*>",  replace = "", gsub(pattern = "&[a-z]*;",  replace = "", final_dat[i,1])))
}
