...
MAPE_bayes_brand_pooled[1,2:3] = apply(MAPE_bayes_brand_pooled[-1,2:3],2,median, na.rm = T)

MAPE = rbind(MAPE, unlist(c('bayes_brand_pooled', MAPE_bayes_brand_pooled[1,2:3])))
...
MAPE_bayes_cat_pooled[1,2:3] = apply(MAPE_bayes_cat_pooled[-1,2:3],2,median, na.rm=T)
MAPE = rbind(MAPE, unlist(c('bayes_cat_pooled', MAPE_bayes_cat_pooled[1,2:3])))
...
model_outputs = c(model_outputs, 'cat_ols', 'brand_ols', 'bayes_brand_pooled', 'bayes_cat_pooled', 'boosting')
...
MAPE_boosting = MAPE_bayes_bc ; MAPE_boosting[,2:3] = NA
